...
def assemble_prompt(parts: ChallengeParts) -> str:
    ...
    return (
        ...
        f'{parts.tests}\n'
        '```\n\n'
        'Evaluate this the way a technical interviewer or senior engineer doing code '
        'review would assess a candidate for a junior/mid-level dev or software '
        'engineering role. Consider: correctness and edge-case handling, code clarity, '
        'whether unspecified behavior (e.g. tie-breaks, invalid input) was handled '
        'deliberately or left to chance, and whether the test suite reflects real '
        'coverage or just happy-path checks. Give a hiring-relevant assessment (e.g. '
        '"junior-ready", "needs more rigor for mid-level", "solid but undertested") as '
        'the first line, with a short justification. Note any strengths that would '
        'stand out for a career-transitioner without inflating the assessment itself.\n'
